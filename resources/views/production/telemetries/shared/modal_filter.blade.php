    ...
    <div class="modal-dialog  modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer bg-light">
                <button type="button" class="btn btn-primary" onclick="formFilter('{{route('alltelemetries')}}');" >{{ __('general.search')}}</button>
...
<script>
    ...
    function formFilter(route,tableId){
            var Dtable =  $('#Telemetries').DataTable();
            var data = $('#Telemetries').DataTable().ajax.params();
            args = {
