    ...
    <div class="modal-dialog  modal-lg" role="document">
        <div class="modal-content">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="type" id="type">
                                    <option value=""></option>
                                    <option value="prod">{{ __('production.production') }}</option>
                                    <option value="dia">{{ __('production.diagnostics') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status" id="status">
                                    <option value=""></option>
                                    <option value="1">{{ __('general.success') }}</option>
                                    <option value="0">{{ __('general.error') }}</option>
                                </select>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer bg-light">
                <button type="button" class="btn btn-primary" onclick="formFilter('{{route('allsyncs')}}');" >{{ __('general.search')}}</button>
...
<script>
    ...
    function formFilter(route,tableId){
            var Dtable =  $('#Syncs').DataTable();
            var data = $('#Syncs').DataTable().ajax.params();
            args = {
