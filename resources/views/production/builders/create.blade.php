...
@section('breadcrumb')
    <li class="breadcrumb-item text-muted">
        <a href="{{url('nations')}}" class="text-muted">{{trans_choice('production.builder',2)}}</a>
    </li>
    <li class="breadcrumb-item text-muted">
...
@section('content')
{!! BootForm::open()
    ->action(route('builders.store'))
    ->post()
    ->id('builder-create')
    ->multipart()
!!}
<div class="card">
    <div class="card-header"><h4>{{__('general.add')}} {{trans_choice('production.builder',1)}}</h4></div>
    <div class="card-body">
